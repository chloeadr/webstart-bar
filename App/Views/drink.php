...
<html lang="en">
    <head>
        ...
        <title><?php echo $drink['name'] ?> | Dungeons & Bourbon</title>
    </head>

    <body>
        <div id="intro" class="container-fluid d-flex flex-column justify-content-between align-items-center header p-5" style="background-image: url('img/<?php echo $drink['bg'] ?>');">
            <div class="row w-100">
            ...
            <div class="row d-flex flex-column justify-content-center align-items-center m-4">
                <p class="baseline mb-3">Read more about this drink</p>
        ...
        <div class="container-fluid main w-100">
            ...
            <div class="row p-5 pb-4">
                <div class="col-6">
                  <img src="img/<?php echo $drink['picture'] ?>" class="w-75" />
                </div>
                <div class="col-6 d-flex flex-column justify-content-center">
                  <div class="row mb-4">
                    <div class="col-6">
                      <h3 class="subtitle"><?php echo $drink['name'] ?></h3>
                    </div>
                    <div class="col-6">
                      <h3 class="subtitle"><?php echo $drink['price'] ?>€</h3>
                    </div>
                  </div>
                  <p class="bodyText"><?php echo $drink['description'] ?></p>
                  <?php 
                  if($drink['alcohol_level'] > 0) {
                    echo "<p class=\"bodyText font-italic\">".$drink['alcohol_level']."% alcohol</p>";
                  }
                  if($drink['composition'] > 0) {
                    echo "<p class=\"bodyText font-italic\">Composition: ".$drink['composition']."</p>";
                  } ?>
                </div>
            </div>
        </div>
